...
export const SERVICES = [
  ...
  },
  {
    ...
    description:
      'Transform raw business data into actionable insights that drive smarter decisions, optimize performance, and accelerate sustainable growth across every digital initiative.',
    includes: [
      'Business Performance Dashboards',
      'Marketing & Campaign Analytics',
      'Customer Behavior & Conversion Insights',
      'KPI Tracking, Reporting & Data Visualization',
    ],
    icon: `<svg width="36" height="36" viewBox="0 0 36 36" fill="none" stroke="currentColor" stroke-width="1.5" aria-hidden="true"><line x1="6" y1="30" x2="30" y2="30"/><rect x="8" y="22" width="4" height="8" rx="1"/><rect x="16" y="14" width="4" height="16" rx="1"/><rect x="24" y="18" width="4" height="12" rx="1"/><polyline points="8,18 14,12 20,16 26,8"/></svg>`,
    accent: '#A87470',
